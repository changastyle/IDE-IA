...
# 1 - EL .command ESTA EN CI-CD-LOCAL/ PERO LOS ARCHIVOS DEL PROYECTO ESTAN ARRIBA:
cd "$(dirname "$0")/.."
...
# ---------------------------------------------------------------------------
echo
echo "[3/5] Generando CI-CD-LOCAL/version-macos.md ..."
...
VERFILE="CI-CD-LOCAL/version-macos.md"
...
pyinstaller --noconfirm --windowed --onefile --name "NG-STUDIO" \
    ...
    --add-data "CI-CD-LOCAL/version-macos.md:CI-CD-LOCAL" \
...
echo "  Version:   $VERSION"
echo "  Historial: CI-CD-LOCAL/version-macos.md  (build $BUILD_NUM)"
echo
